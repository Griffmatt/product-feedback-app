        ...
        <div className="column">
            <div className="header">
                <div className="header__menu">
                    ...
                    <h3 className="header__amount">{filteredSuggestions.length} Suggestions</h3>
                    <label className="p-2 header__select">
                        Sort by : 
                        <span> Most Upvotes
                            <svg width="13" height="8" xmlns="http://www.w3.org/2000/svg"><path d="M1 1l4 4 4-4" strokeWidth="2" fill="none" fillRule="evenodd"/></svg>
                        </span>
                    </label>
                </div>
