    ...
    <div className="container">
        <div className="nav">
            <div className="nav__banner">
                ...
                <svg width="20" height="17" xmlns="http://www.w3.org/2000/svg" className="nav__image"><g fill="#FFF" fillRule="evenodd"><path d="M0 0h20v3H0zM0 7h20v3H0zM0 14h20v3H0z"/></g></svg>
            </div>
        ...
        <div className="column">
            ...
            <div className="grid">
                ...
                <div className="card card--grid">
                    <div className="card__text">
                        <h3>There is no feedback yet.</h3>
                        <p className="p-2">Got a suggestion? Found a bug that needs to be squashed? We love hearing about new ideas to improve our app.</p>
                    </div>
