...
function RoadmapCard({suggestion, color}: props) {
  ...
  return (
    <div className={`roadmap__card roadmap__card--grid roadmap__card--${color}`}>
        <div className="roadmap__card--text">
            <h3>{suggestion.title}</h3>
            <p className="p-2">{suggestion.description}</p>
        </div>
        <div className="roadmap__card--feature">
            <p className="p-2">{suggestion.category}</p>
        </div>
        <div className={`roadmap__card--up-vote ${active?"roadmap__card--up-vote--active": ""}`} onClick={(e)=> handleUpVote(e)}>
        ...
        <div className="roadmap__card--comments">
